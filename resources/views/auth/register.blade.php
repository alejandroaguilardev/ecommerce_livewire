                        ...
                        <div class="register-form form-item ">
                            ...
                            <form class="form-stl" action="{{route('register')}}" name="frm-login" method="post" >
                                ...
                                <fieldset class="wrap-input">
                                    <label for="frm-reg-lname">Nombre y Apellido*</label>
                                    <input type="text" id="frm-reg-lname" name="name" placeholder="Alejandro Aguilar*" ::value="name" required autofocus autocomplete="name">
                                </fieldset>
                                <fieldset class="wrap-input">
                                    <label for="frm-reg-email">Correo Electrónico*</label>
                                    <input type="email" id="frm-reg-email" name="email" placeholder="user@mail.com" required  :value="email">
                                </fieldset>
                               
                                <fieldset class="wrap-title">
                                    <h3 class="form-title">Información de la Cuenta</h3>
                                </fieldset>
